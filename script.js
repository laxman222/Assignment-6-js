...
cardImgDiv.src= imgUrl;
cardImgDiv.alt= imgAlt;
...
var cardHeaderDiv = document.createElement('h1');
cardHeaderDiv.classList.add('cardHeader');
cardHeaderDiv.innerText = header;
cardContentDiv.appendChild(cardHeaderDiv);

var cardTextDiv = document.createElement('p');
cardTextDiv.classList.add('cardText');
cardTextDiv.innerText = description;
...
for(var i=0;i<cards.length;i++){
    ...
    var Card = createCards(cards[i].imgUrl, cards[i].imgAlt, cards[i].header, cards[i].description)
